...
public class AboutDeviceNamePreferenceController extends BasePreferenceController {
    ...
    private static final String KEY_DEVICE_MIST_PROP = "ro.mist.device";
	...
	String deviceModel =  SystemProperties.get(KEY_DEVICE_MODEL_PROP);
        String deviceMist = SystemProperties.get(KEY_DEVICE_MIST_PROP);
	if (!deviceName.isEmpty() && !deviceModel.isEmpty() && !deviceMist.isEmpty())
	    return deviceMist + " | " + deviceName + " (" + deviceModel + ")";
	else
