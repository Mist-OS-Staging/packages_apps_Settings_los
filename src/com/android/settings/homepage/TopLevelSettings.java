...
import static com.android.settings.mist.MistConstants.DASHBOARD_STYLE_NAD;
...
public class TopLevelSettings extends DashboardFragment implements SplitLayoutListener,
    ...
    private static final String TOP_LEVEL_MIST_CATEGORY= "top_level_mist_category";
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        if (mDashboardStyle != DASHBOARD_STYLE_AOSP_LEGACY) return;
        }
