package com.android.settings.mist.homepage;
...
public class DotTopMenu extends Preference {
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        LinearLayout mMist = holder.itemView.findViewById(context.getResources().
                getIdentifier("id/mist_settings", null, context.getPackageName()));
        mMist.setClickable(true);
