...
public class MistAboutPreference extends BasePreferenceController implements View.OnTouchListener {
    ...
    public MistAboutPreference(Context context, String key) {
        super(context, key);
